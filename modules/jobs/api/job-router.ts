...
const setVerifyAnswerInput = z.object({ jobId: z.string().uuid(), itemId: z.string().min(1), state: z.enum(["pass", "override", "clear"]), via: z.string().max(50).nullable().optional(), reason: z.string().max(2000).nullable().optional() });
