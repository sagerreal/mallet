...
const p = await b.newPage({ viewport: { width: 1512, height: 1400 } }); // taller viewport
...
// Find crew member and click to expand
...
// Scroll to bottom to see the expanded crew section
await p.evaluate(() => window.scrollTo(0, document.body.scrollHeight));
await p.waitForTimeout(500);

// Take viewport screenshot (not fullPage) to show the crew section
