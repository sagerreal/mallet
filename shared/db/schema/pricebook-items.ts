...
export const pricebookItems = pgTable(
  ...
  (t) => [
    ...
    check(
      ...
      sql`${t.measuredBy} is null or ${t.measuredBy} in ('hour', 'walls_sqft', 'ceiling_sqft', 'soffit_sqft', 'baseboard_lnft', 'baseboard_sqft', 'crown_lnft', 'crown_sqft', 'doors_count', 'windows_count', 'site_sqft', 'site_lnft')`,
    ),
  ],
);
