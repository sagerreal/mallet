...
describe("JobChecklistBlock — entry + picker", () => {
  ...
  it("attaches an existing template through updateJob", () => {
...
describe("JobChecklistBlock — create form", () => {
  ...
  it("creates the template, types items via the photo heuristic, and attaches", () => {
    openForm();
  ...
  it("folds a typed-but-not-added item row into the attach", () => {
    openForm();
    fireEvent.change(screen.getByPlaceholderText(/Name — e.g./), {
